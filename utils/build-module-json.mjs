...
template.url = "https://github.com/toastygm/hm-loc-drilen";
template.bugs = "https://github.com/toastygm/hm-loc-drilen/issues";
template.manifest =
    "https://github.com/toastygm/hm-loc-drilen/releases/latest/download/module.json";
template.download = `https://github.com/toastygm/hm-loc-drilen/releases/download/v${pkg.version}/module.zip`;
